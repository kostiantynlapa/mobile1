...
fun main() {
    ...
    println("Working mass composition: H= ${String.format("%.2f", workingComposition[1])}%, C= ${String.format("%.2f", workingComposition[0])}%, S= ${String.format("%.2f", workingComposition[3])}%, O= ${String.format("%.2f", workingComposition[2])}%, A= ${String.format("%.2f", workingComposition[4])}%, V= ${String.format("%.2f", vr)} mg/kg")
